...
const NotificationItem = ({ notification, onDelete }) => {
  ...
  return (
    <li className="notification-item-mobile" {...handlers}>
...
const Notification = () => {
  ...
  return (
    <div className="notification-container-mobile">
      <h2 className="notification-title-mobile">Notifications</h2>
      {notifications.length === 0 ? (
        <p className="no-notifications-mobile">No notifications</p>
      ) : (
        <ul className="notification-list-mobile">
      ...
      {notifications.length > 0 && (
        <button className="clear-button-mobile" onClick={handleClearAll}>
          Clear All
        </button>
      )}
    </div>
